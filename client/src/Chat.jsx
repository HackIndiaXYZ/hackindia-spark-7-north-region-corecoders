...
export default function Chat() {
   ...
   // ── Stable refs (never change after mount, safe in socket closure) ──
   ...
   useEffect(() => {
      ...
      setIsAdmin(
         isCreating || sessionStorage.getItem("chat_isAdmin") === "true",
      );
      isAdminRef.current =
         isCreating || sessionStorage.getItem("chat_isAdmin") === "true";
      setRoomName(
      ...
      socket.on("user_kicked", ({ username: u }) => {
         setMessages((prev) => [
            ...
            {
               type: "system",
               text: `${u} was removed from the room.`,
               timestamp: Date.now(),
            },
         ]);
      });
      ...
      socket.on("code_changed", () => {
         setCodeMsg("Room code updated successfully.");
         setNewCode("");
            ...
            >
               <div style={{ flex: 1, minWidth: "220px" }}>
                  ...
                  {codeMsg && (
                     <p
                        style={{
                           color: codeMsg.includes("updated")
                              ? "#86efac"
                              : "#f87171",
                           fontSize: "11px",
                           marginTop: "6px",
                        ...
                        members.map((m) => (
                           ...
                           >
                              ...
                              {!m.isCreator && (
                                 <button
                                    onClick={() =>
                                       kickUser(m.socketId, m.username)
                                    }
                                    style={{
